        ...
        >
          ...
          <g className="comp1" onClick={display1Changer}>
            <g filter="url(#filter0_b_268_37)">
              <rect
                ...
                height="44.558"
                rx="22.279"
                transform="rotate(-8.23992 324.312 547.9)"
                stroke="url(#paint4_linear_268_37)"
                stroke-width="0.550826"
                fill="url(#paint3_linear_268_37)"
                fill-opacity="0.5"
              />
            </g>
            <ellipse
          ...
          <g className="comp2" onClick={display2Changer}>
            <g filter="url(#filter2_b_268_37)">
              <rect
                ...
                height="44.558"
                rx="22.279"
                transform="rotate(-8.23992 706.312 495.9)"
                stroke="url(#paint11_linear_268_37)"
                stroke-width="0.550826"
                fill="url(#paint10_linear_268_37)"
                fill-opacity="0.5"
              />
            </g>
            <ellipse
          ...
          <g className="comp3" onClick={display3Changer}>
            <g filter="url(#filter1_b_268_37)">
              <rect
                ...
                height="44.558"
                rx="22.279"
                transform="rotate(-8.23992 1105.31 431.9)"
                stroke="url(#paint8_linear_268_37)"
                stroke-width="0.550826"
                fill="url(#paint7_linear_268_37)"
                fill-opacity="0.5"
              />
            </g>
            <ellipse
          ...
          <g className="comp4" onClick={display4Changer}>
            <g filter="url(#filter3_b_268_37)">
              <rect
                ...
                height="44.558"
                rx="22.279"
                transform="rotate(-8.23992 1404.31 280.9)"
                stroke="url(#paint15_linear_268_37)"
                stroke-width="0.550826"
                fill="url(#paint14_linear_268_37)"
                fill-opacity="0.5"
              />
            </g>
            <ellipse
          ...
          <defs>
            ...
            >
              ...
              <feGaussianBlur in="BackgroundImage" stdDeviation="2.61642" />
              <feComposite
                in2="SourceAlpha"
                operator="in"
                result="effect1_backgroundBlur_268_37"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_backgroundBlur_268_37"
                result="shape"
              />
            </filter>
            <filter
            ...
            >
              ...
              <stop offset="0.604167" stop-color="#0E734B" />
              <stop offset="1" stop-color="#0E734B" stop-opacity="0" />
            </linearGradient>
            <linearGradient
              id="paint1_linear_268_37"
              x1="350.5"
              y1="267"
              x2="350.5"
              y2="867"
              gradientUnits="userSpaceOnUse"
            >
              <stop stop-color="#52CC82" stop-opacity="0.222222" />
              <stop offset="0.578125" stop-color="#52CC82" />
              <stop offset="1" stop-color="#52CC82" stop-opacity="0" />
            </linearGradient>
            <linearGradient
              id="paint2_linear_268_37"
              x1="399"
              y1="361"
              x2="556.881"
              y2="361"
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset="0.140625" stop-opacity="0.33" />
              <stop offset="0.6875" stop-color="#060302" stop-opacity="0.19" />
              <stop offset="0.9999" stop-color="#703219" stop-opacity="0" />
              <stop offset="1" stop-color="#070711" stop-opacity="0" />
            </linearGradient>
            <linearGradient
              id="paint4_linear_268_37"
              x1="347.259"
              y1="547.667"
              x2="347.259"
              y2="592.776"
